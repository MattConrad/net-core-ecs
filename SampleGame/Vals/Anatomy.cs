...
namespace SampleGame.Vals
{
    ...
    public enum BodySlots : long
    {
        ...
        HumanWaist = 0b000000000000000000000000000000000000000000000000000000100000000,
        HumanGroin = 0b000000000000000000000000000000000000000000000000000001000000000,
        HumanGlovesPair = 0b000000000000000000000000000000000000000000000000000010000000000,
        HumanBootsPair = 0b000000000000000000000000000000000000000000000000000100000000000,
        HumanArmLeft = 0b000000000000000000000000000000000000000000000000001000000000000,
        HumanArmRight = 0b000000000000000000000000000000000000000000000000010000000000000,
        HumanLegLeft = 0b000000000000000000000000000000000000000000000000100000000000000,
        HumanLegRight = 0b000000000000000000000000000000000000000000000001000000000000000,
        HumanWristLeft = 0b000000000000000000000000000000000000000000000010000000000000000,
        HumanWristRight = 0b000000000000000000000000000000000000000000000100000000000000000,
        HumanRingFingerLeft = 0b000000000000000000000000000000000000000000001000000000000000000,
        HumanRingFingerRight = 0b000000000000000000000000000000000000000000010000000000000000000,
        HumanEyeLeft = 0b000000000000000000000000000000000000000000100000000000000000000,
        HumanEyeRight = 0b000000000000000000000000000000000000000001000000000000000000000,
        HumanEarLeft = 0b000000000000000000000000000000000000000010000000000000000000000,
        HumanEarRight = 0b000000000000000000000000000000000000000100000000000000000000000,
        HumanNose = 0b000000000000000000000000000000000000001000000000000000000000000,
        HumanMouth = 0b000000000000000000000000000000000000010000000000000000000000000,
