...
namespace SampleGame.Parts
{
    ...
    internal class Container : EntropyEcsCore.EcsEntityPart
    {
        ...
        /// <summary>
        /// If the entity with this component isn't primarily a container, this is the description for the container part of the entity. e.g., "pack" for a person, or "trunk" for a car.
        /// </summary>
